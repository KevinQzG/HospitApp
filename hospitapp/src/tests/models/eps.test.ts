...
describe('EPS Class', () => {
  ...
  beforeEach(() => {
    eps = new Eps(TEST_EPS_ID, TEST_EPS_NAME, TEST_EPS_PHONE, TEST_EPS_FAX, TEST_EPS_EMAILS);
  });
  ...
  describe('Constructor', () => {
    ...
    it('should generate new ObjectId when not provided', () => {
      const NEW_EPS = new Eps(undefined, TEST_EPS_NAME, TEST_EPS_PHONE, TEST_EPS_FAX, TEST_EPS_EMAILS);
  ...
  describe('Validation', () => {
    ...
    it('should throw error when name is missing', () => {
      const INVALID_EPS = new Eps(undefined, '', TEST_EPS_PHONE, TEST_EPS_FAX, TEST_EPS_EMAILS);
      expect(() => INVALID_EPS.validate()).toThrow('Missing required fields');
    });
  });
