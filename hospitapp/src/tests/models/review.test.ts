...
describe("Review Model", () => {
  ...
  describe("Validation", () => {
    ...
    it("should throw error when rating is less than 0", () => {
      ...
      expect(() => invalidReview.validate()).toThrow("Invalid rating value");
    });
  ...
  describe("Serialization", () => {
    it("should convert to document correctly", () => {
      ...
      expect(ReviewMapper.fromDomainToDocument).toHaveBeenCalledWith(review);
      expect(doc).toEqual({
        _id: TEST_ID,
        user: TEST_USER,
        ips: TEST_IPS,
    ...
    it("should convert to response correctly", () => {
      ...
      expect(ReviewMapper.fromDomainToResponse).toHaveBeenCalledWith(review);
