...
import { Stethoscope, HeartPulse, Brain, User, Hospital, Candy, Baby, Scissors, Pill} from "lucide-react";
  ...
  return (
    <section className="py-12 sm:py-16 text-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h3 className="text-2xl sm:text-3xl font-bold text-gray-800">Especialidades más buscadas</h3>
        <p className="text-sm sm:text-base text-gray-500 mt-2">
          No encuentras la especialidad que buscas? <a href="specialties" className="text-blue-500 hover:underline">Ver todas las especialidades</a>
        </p>
