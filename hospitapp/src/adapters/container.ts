...
import SearchIpsServiceAdapter from "./services/search_ips.service.adapter";
...
CONTAINER.bind<SearchIpsServiceAdapter>(TYPES.SearchIpsServiceAdapter).to(
	SearchIpsMongoService
);
