  ...
  return (
    <html lang="es">
      <head>
        ...
        <link rel="shortcut icon" type="image/png" sizes="192x192" href="/icons/icon-192x192.png" />
        <link rel="shortcut icon" type="image/png" sizes="512x512" href="/icons/icon-512x512.png" />
