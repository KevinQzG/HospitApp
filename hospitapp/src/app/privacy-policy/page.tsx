       ...
       <div className="mt-16 max-w-4xl mx-auto space-y-12 text-gray-800 leading-relaxed">
         ...
         <div className="bg-white p-8 rounded-lg shadow-md">
           ...
           <div className="space-y-2">
             <p className="text-lg font-semibold text-gray-900">📧 <a href="mailto:admin@hospitapp.com" className="text-blue-600 hover:underline">admin@hospitapp.com</a></p>
             <p className="text-lg font-semibold text-gray-900">📍 Medellín, Antioquia, Colombia</p>
           </div>
         </div>
       </div>
     </section>
